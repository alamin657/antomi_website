                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <div class="product_thumb">
                                ...
                                {{-- <a class="secondary_img" href="{{route('client.cart')}}"><img
                                ...
                                <div class="action_links">
                                    <ul>
                                        ...
                                        <li class="compare"><a href="#" data-tippy-placement="top"
                                                ...
                                                data-tippy="Add to Compare"><i class="ion-ios-settings-strong"></i></a>
                                        </li>
                    ...
                    <div class="product_carousel product_style product_column5 owl-carousel">
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="{{route('client.product_details')}}">Natus
                                                erro at congue massa commodo sit Natus erro</a></h4>
                                        <div class="price_box">
                                            <span class="old_price">৳80.00</span>
                                            <span class="current_price">৳70.00</span>
                                        </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="{{route('client.product_details')}}">Eodem
                                                modo vel mattis ante facilisis nec porttitor efficitur</a></h4>
                                        <div class="price_box">
                                            <span class="old_price">৳86.00</span>
                                            <span class="current_price">৳79.00</span>
                                        </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="{{route('client.product_details')}}">Donec
                                                tempus pretium arcu et faucibus commodo</a></h4>
                                        <div class="price_box">
                                            <span class="old_price">৳82.00</span>
                                            <span class="current_price">৳75.00</span>
                                        </div>
...
<div class="action_links">
    <ul>
        ...
        <li class="compare"><a href="#" data-tippy-placement="top" data-tippy-arrow="true" data-tippy-inertia="true"
                data-tippy="Add to Compare"><i class="ion-ios-settings-strong"></i></a></li>
